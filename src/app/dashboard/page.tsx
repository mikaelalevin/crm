...
const MOCK_INSIGHTS = [
  {
    id: "1",
    dot: "#B47A75",
    title: "Loyal Romantics-segmentet är redo att handla igen",
    body: "214 kunder i ditt mest värdefulla segment har inte fått ett mejl på 18 dagar. Baserat på deras tidigare köpcykel är 73% redo att handla nu. Genomsnittlig ordervärde: 1 840 kr.",
    actions: [
  ...
  },
  {
    ...
    body: "De har minskat sin köpfrekvens med 60% senaste 90 dagarna. Föreslagen åtgärd: personlig win-back med exklusivt förhandsvisning av FW26-kollektionen.",
    actions: [
...
const MOCK_SEGMENTS = [
  {
    ...
    desc: "Återkommande kunder som älskar säsongskollektioner och höga ordervärden.",
    tag: "Mest värdefull",
  ...
  },
  {
    id: "trends",
    name: "Trend Hunters",
    desc: "Köper alltid nya releaser först. Snabba beslut, hög engagemangsgrad.",
    tag: "Tidiga adopters",
    gradient: "linear-gradient(135deg, #1A1614 0%, #3D3530 100%)",
    customers: "847",
    ltv: "8 900 kr",
    active: "88%",
    suggestion: "Förhandsvisning av FW26 kommer öka konvertering med ~40%.",
  },
  {
    id: "vip",
    name: "Best Friends",
    desc: "Dina mest lojala kunder. Förtjänar personlig kommunikation och exklusivitet.",
    tag: "VIP — Topp 5%",
    gradient: "linear-gradient(135deg, #C9A961 0%, #8A7038 100%)",
    customers: "312",
    ltv: "42 800 kr",
    active: "96%",
    suggestion: "28 visar drift-signaler — handpersonlig win-back rekommenderas.",
  },
];
