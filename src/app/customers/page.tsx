...
const MOCK_CUSTOMERS = [
  { initials: "EW", gradient: "linear-gradient(135deg,#D4A5A0,#B47A75)", name: "Elsa Wikström", email: "elsa.w@gmail.com", segment: "Loyal Romantics", segColor: "#F4DDD9", segText: "#6F3F3A", ltv: "32 400 kr", next: "22 maj · Linen Mini Dress", prob: 92, status: "Aktiv", statusColor: "#DDE7D7", statusText: "#3E4F36" },
  { initials: "AL", gradient: "linear-gradient(135deg,#C9A961,#8A7038)", name: "Amanda Lundqvist", email: "amanda@studio.se", segment: "Best Friends", segColor: "#F2E5C5", segText: "#6A4E1B", ltv: "41 800 kr", next: "24 maj · Cashmere Cardigan", prob: 89, status: "VIP", statusColor: "#DDE7D7", statusText: "#3E4F36" },
  { initials: "FM", gradient: "linear-gradient(135deg,#1A1614,#4D3A35)", name: "Felicia Magnusson", email: "felicia.m@me.com", segment: "Trend Hunters", segColor: "#1A1614", segText: "#FAF7F2", ltv: "11 200 kr", next: "20 maj · Oversized Blazer", prob: 87, status: "Aktiv", statusColor: "#DDE7D7", statusText: "#3E4F36" },
  { initials: "VK", gradient: "linear-gradient(135deg,#A8B5A0,#6B7A63)", name: "Vera Karlsson", email: "vera.k@gmail.com", segment: "Curious Newcomers", segColor: "#DDE7D7", segText: "#3E4F36", ltv: "980 kr", next: "28 maj · Cotton T-shirt", prob: 64, status: "Ny", statusColor: "#DDE7D7", statusText: "#3E4F36" },
  { initials: "JE", gradient: "linear-gradient(135deg,#6B4F5B,#3D2C35)", name: "Johanna Ekberg", email: "johanna.e@hotmail.com", segment: "About to Drift", segColor: "#E3D5DC", segText: "#4D3540", ltv: "14 600 kr", next: "Osäker", prob: 22, status: "Risk", statusColor: "#F4DDD9", statusText: "#6F3F3A" },
  { initials: "CN", gradient: "linear-gradient(135deg,#C8BCAE,#A8998A)", name: "Carolina Nilsson", email: "carolina.n@me.com", segment: "Sleeping Beauties", segColor: "#F2EDE5", segText: "#5C544F", ltv: "6 200 kr", next: "Behöver väckning", prob: 18, status: "Inaktiv", statusColor: "#F2EDE5", statusText: "#5C544F" },
];
